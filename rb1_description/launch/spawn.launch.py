...
def launch_setup(context, *args, **kwargs):
    ...
    xacro_file = 'rb1.xacro.urdf'

    
    package_description = "rb1_description"
    ...
    return [start_gazebo_ros_spawner_cmd]
...
def generate_launch_description(): 
    ...
    entity_name_arg = DeclareLaunchArgument('entity_name', default_value='rb1')
